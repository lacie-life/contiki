...
_cycle_start:
	.ds 2
_powercycle_sync_cycle_start_65536_408:
	.ds 2
_powercycle_sync_cycle_phase_65536_408:
	.ds 1
_powercycle_packet_seen_262144_412:
	.ds 1
_powercycle_t0_262144_412:
	.ds 2
_powercycle_count_262144_412:
	.ds 1
_powercycle_start_327680_421:
	.ds 2
_powercycle_silence_periods_327680_421:
	.ds 1
_powercycle_periods_327680_421:
	.ds 1
_input_packet_ct_65536_497:
	.ds 21
;--------------------------------------------------------
...
;sync_cycle_start          Allocated with name '_powercycle_sync_cycle_start_65536_408'
;sync_cycle_phase          Allocated with name '_powercycle_sync_cycle_phase_65536_408'
;packet_seen               Allocated with name '_powercycle_packet_seen_262144_412'
;t0                        Allocated with name '_powercycle_t0_262144_412'
;count                     Allocated with name '_powercycle_count_262144_412'
;start                     Allocated with name '_powercycle_start_327680_421'
;silence_periods           Allocated with name '_powercycle_silence_periods_327680_421'
;periods                   Allocated with name '_powercycle_periods_327680_421'
;------------------------------------------------------------
...
;	../../core/net/mac/contikimac.c:369: sync_cycle_start = RTIMER_NOW();
	...
	addc	a,r3
	mov	r3,a
	mov	dptr,#_powercycle_sync_cycle_start_65536_408
	mov	a,r2
	movx	@dptr,a
	mov	a,r3
	inc	dptr
...
;	../../core/net/mac/contikimac.c:381: if (sync_cycle_phase++ == NETSTACK_RDC_CHANNEL_CHECK_RATE) {
	mov	dptr,#_powercycle_sync_cycle_phase_65536_408
	movx	a,@dptr
	mov	r3,a
	inc	a
	movx	@dptr,a
...
;	../../core/net/mac/contikimac.c:396: packet_seen = 0;
	mov	dptr,#_powercycle_packet_seen_262144_412
	clr	a
	movx	@dptr,a
;	../../core/net/mac/contikimac.c:398: for(count = 0; count < CCA_COUNT_MAX; ++count) {
	mov	dptr,#_powercycle_count_262144_412
	movx	@dptr,a
00162$:
;	../../core/net/mac/contikimac.c:399: t0 = RTIMER_NOW();
	...
	addc	a,r3
	mov	r3,a
	mov	dptr,#_powercycle_t0_262144_412
	mov	a,r2
	movx	@dptr,a
	mov	a,r3
	inc	dptr
...
;	../../core/net/mac/contikimac.c:421: start = RTIMER_NOW();
	...
	addc	a,r7
	mov	r7,a
	mov	dptr,#_powercycle_start_327680_421
	mov	a,r6
	movx	@dptr,a
	mov	a,r7
	inc	dptr
...
;	../../core/net/mac/contikimac.c:423: periods = silence_periods = 0;
	mov	dptr,#_powercycle_silence_periods_327680_421
	clr	a
	movx	@dptr,a
	mov	dptr,#_powercycle_periods_327680_421
	movx	@dptr,a
...
;------------------------------------------------------------
;mac_callback_ptr          Allocated to stack - sp -29
;buf_list                  Allocated to stack - sp -32
;mac_callback              Allocated to stack - sp -24
;t0                        Allocated to stack - sp -11
;encounter_time            Allocated to stack - sp -9
;strobes                   Allocated to registers 
;got_strobe_ack            Allocated to stack - sp -14
;hdrlen                    Allocated to registers r6 r7 
;len                       Allocated to registers r6 r7 
;is_broadcast              Allocated to stack - sp -7
;is_reliable               Allocated to registers 
;is_known_receiver         Allocated to stack - sp -15
;collisions                Allocated to stack - sp -16
;transmit_len              Allocated to registers r4 r7 
;ret                       Allocated to registers r6 r7 
;contikimac_was_on         Allocated to stack - sp -12
;seqno                     Allocated to stack - sp -13
;chdr                      Allocated to registers r2 r4 r5 
;ptr                       Allocated to stack - sp -6
;i                         Allocated to registers r3 r4 
;wt                        Allocated to stack - sp -6
...
;ct                        Allocated with name '_input_packet_ct_65536_497'
;------------------------------------------------------------
...
;	../../core/net/mac/contikimac.c:956: ctimer_set(&ct, INTER_PACKET_DEADLINE, recv_burst_off, NULL);
	...
	clr	a
	push	acc
	mov	dptr,#_input_packet_ct_65536_497
	mov	b,#0x00
	lcall	_ctimer_set
	mov	a,sp
	add	a,#0xf9
