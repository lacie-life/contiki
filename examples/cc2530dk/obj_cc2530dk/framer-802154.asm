...
;	../../core/net/mac/framer-802154.c:110: packetbuf_set_attr(PACKETBUF_ATTR_MAC_SEQNO, frame.seq);
	...
	dec	sp
00108$:
;	../../core/net/mac/framer-802154.c:120: frame.fcf.src_addr_mode = FRAME802154_SHORTADDRMODE;
...
;	../../core/net/mac/framer-802154.c:137: rimeaddr_copy((rimeaddr_t *)&frame.dest_addr,
	...
	dec	sp
	dec	sp
;	../../core/net/mac/framer-802154.c:141: frame.fcf.dest_addr_mode = FRAME802154_SHORTADDRMODE;
	mov	dptr,#(_frame + 0x0005)
	mov	a,#0x02
	movx	@dptr,a
00111$:
