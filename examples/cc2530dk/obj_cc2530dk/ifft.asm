...
;------------------------------------------------------------
;nu                        Allocated to stack - sp -7
;j                         Allocated to stack - sp -3
;k                         Allocated to stack - sp -1
;------------------------------------------------------------
...
;------------------------------------------------------------
;xim                       Allocated to stack - sp -59
;n                         Allocated to stack - sp -61
;xre                       Allocated to stack - sp -54
;nu                        Allocated to stack - sp -25
;n2                        Allocated to stack - sp -23
;nu1                       Allocated to stack - sp -21
;p                         Allocated to registers r3 r4 
;k                         Allocated to registers r2 r5 
...
;sloc1                     Allocated to stack - sp -49
;sloc2                     Allocated to stack - sp -47
;sloc3                     Allocated to stack - sp -45
;sloc4                     Allocated to stack - sp -13
;sloc5                     Allocated to stack - sp -43
;sloc6                     Allocated to stack - sp -40
;sloc7                     Allocated to stack - sp -36
;sloc8                     Allocated to stack - sp -32
;sloc9                     Allocated to stack - sp -29
;------------------------------------------------------------
