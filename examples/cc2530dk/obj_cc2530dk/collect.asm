...
;old_rtmetric              Allocated to stack - sp -3
;new_rtmetric              Allocated to stack - sp -1
;------------------------------------------------------------
...
;max_mac_rexmits           Allocated to registers r5 r6 
;sloc0                     Allocated to stack - sp -9
;------------------------------------------------------------
...
;	../../core/net/rime/collect.c:815: if(msg.flags & ACK_FLAGS_CONGESTED) {
	...
	ljmp	00108$
00165$:
;	../../core/net/rime/collect.c:817: if(n != NULL) {
	mov	a,r4
	orl	a,r3
	jz	00106$
;	../../core/net/rime/collect.c:818: collect_neighbor_set_congested(n);
	mov	dpl,r4
	mov	dph,r3
	mov	b,r2
	push	ar4
	...
	pop	ar3
	pop	ar4
;	../../core/net/rime/collect.c:819: collect_neighbor_tx(n, tc->max_rexmits * 2);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	a,#0xa5
	...
	pop	ar4
00106$:
;	../../core/net/rime/collect.c:821: update_rtmetric(tc);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	dpl,@r0
	...
	pop	ar4
00108$:
;	../../core/net/rime/collect.c:823: if((msg.flags & ACK_FLAGS_DROPPED) == 0) {
	mov	a,@r1
	mov	r7,a
	jb	acc.6,00113$
;	../../core/net/rime/collect.c:825: send_next_packet(tc);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	dpl,@r0
	...
	ljmp	00114$
00113$:
;	../../core/net/rime/collect.c:830: if((msg.flags & ACK_FLAGS_LIFETIME_EXCEEDED)) {
	mov	a,r7
	jnb	acc.5,00110$
;	../../core/net/rime/collect.c:831: send_next_packet(tc);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	dpl,@r0
	...
	ljmp	00114$
00110$:
;	../../core/net/rime/collect.c:837: collect_neighbor_tx(n, tc->max_rexmits);
	push	ar1
	mov	a,sp
	add	a,#0xf7
	mov	r0,a
	...
	dec	sp
	pop	ar1
;	../../core/net/rime/collect.c:838: update_rtmetric(tc);
	mov	a,sp
	add	a,#0xf7
	mov	r0,a
	mov	dpl,@r0
	...
	lcall	_update_rtmetric
	pop	ar1
;	../../core/net/rime/collect.c:842: retransmit_callback, tc);
	mov	a,sp
	add	a,#0xf7
	mov	r0,a
	mov	ar5,@r0
	...
	inc	r0
	mov	ar7,@r0
;	../../core/net/rime/collect.c:841: REXMIT_TIME + (random_rand() % (REXMIT_TIME)),
	push	ar7
	push	ar6
	push	ar5
	push	ar1
	...
	inc	r0
	mov	@r0,ar4
;	../../core/net/rime/collect.c:840: ctimer_set(&tc->retransmission_timer,
	mov	a,sp
	add	a,#0xf7
	mov	r0,a
	mov	a,#0x34
	...
	mov	sp,a
	pop	ar1
;	../../core/net/rime/collect.c:853: stats.badack++;
	pop	ar1
;	../../core/net/rime/collect.c:840: ctimer_set(&tc->retransmission_timer,
00114$:
;	../../core/net/rime/collect.c:848: if(msg.flags & ACK_FLAGS_RTMETRIC_NEEDS_UPDATE) {
	mov	a,@r1
	jnb	acc.4,00116$
;	../../core/net/rime/collect.c:849: bump_advertisement(tc);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	dpl,@r0
	...
	lcall	_bump_advertisement
00116$:
;	../../core/net/rime/collect.c:851: set_keepalive_timer(tc);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	dpl,@r0
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:858: send_ack(struct collect_conn *tc, const rimeaddr_t *to, int flags)
;	-----------------------------------------
;	 function send_ack
;	-----------------------------------------
_send_ack:
	...
	add	a,#0x05
	mov	sp,a
;	../../core/net/rime/collect.c:861: uint16_t packet_seqno = packetbuf_attr(PACKETBUF_ATTR_PACKET_ID);
	mov	dpl,#0x0d
	lcall	_packetbuf_attr
	mov	r0,sp
	dec	r0
	...
	inc	r0
	mov	@r0,dph
;	../../core/net/rime/collect.c:863: packetbuf_clear();
	lcall	_packetbuf_clear
;	../../core/net/rime/collect.c:864: packetbuf_set_datalen(sizeof(struct ack_msg));
	mov	dptr,#0x0004
	lcall	_packetbuf_set_datalen
;	../../core/net/rime/collect.c:865: ack = packetbuf_dataptr();
	lcall	_packetbuf_dataptr
	mov	r2,dpl
	mov	r3,dph
	mov	r4,b
	...
	inc	r0
	mov	@r0,ar4
;	../../core/net/rime/collect.c:866: memset(ack, 0, sizeof(struct ack_msg));
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	ar5,@r0
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:867: ack->rtmetric = tc->rtmetric;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x02
	...
	mov	a,r3
	lcall	__gptrput
;	../../core/net/rime/collect.c:868: ack->flags = flags;
	mov	a,sp
	add	a,#0xf2
	mov	r0,a
	mov	ar7,@r0
	...
	mov	a,r7
	lcall	__gptrput
;	../../core/net/rime/collect.c:870: packetbuf_set_addr(PACKETBUF_ADDR_RECEIVER, to);
	mov	a,sp
	add	a,#0xf4
	mov	r0,a
	mov	a,@r0
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:871: packetbuf_set_attr(PACKETBUF_ATTR_PACKET_TYPE, PACKETBUF_ATTR_PACKET_TYPE_ACK);
	mov	a,#0x01
	push	acc
	clr	a
	push	acc
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:872: packetbuf_set_attr(PACKETBUF_ATTR_RELIABLE, 0);
	clr	a
	push	acc
	push	acc
	mov	dpl,#0x0c
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:873: packetbuf_set_attr(PACKETBUF_ATTR_ERELIABLE, 0);
	clr	a
	push	acc
	push	acc
	mov	dpl,#0x17
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:874: packetbuf_set_attr(PACKETBUF_ATTR_PACKET_ID, packet_seqno);
	mov	r0,sp
	dec	r0
	mov	a,@r0
	push	acc
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:875: packetbuf_set_attr(PACKETBUF_ATTR_MAX_MAC_TRANSMISSIONS, MAX_ACK_MAC_REXMITS);
	mov	a,#0x05
	push	acc
	clr	a
	push	acc
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:876: unicast_send(&tc->unicast_conn, to);
	mov	a,sp
	add	a,#0xf4
	mov	r0,a
	mov	a,@r0
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:883: RIMESTATS_ADD(acktx);
...
00103$:
	...
	inc	dptr
	movx	@dptr,a
;	../../core/net/rime/collect.c:884: stats.acksent++;
...
;------------------------------------------------------------
;tc                        Allocated to registers r7 r6 r5 
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:888: add_packet_to_recent_packets(struct collect_conn *tc)
;	-----------------------------------------
...
_add_packet_to_recent_packets:
	...
	mov	r6,dph
	mov	r5,b
;	../../core/net/rime/collect.c:894: if(packetbuf_datalen() > sizeof(struct data_msg_hdr)) {
	push	ar7
	push	ar6
	push	ar5
	...
	ljmp	00103$
00109$:
;	../../core/net/rime/collect.c:895: recent_packets[recent_packet_ptr].eseqno =
	...
	addc	a,r4
	mov	r4,a
;	../../core/net/rime/collect.c:896: packetbuf_attr(PACKETBUF_ATTR_EPACKET_ID);
	mov	dpl,#0x15
	push	ar7
	push	ar6
	push	ar5
	...
	mov	a,r2
	movx	@dptr,a
;	../../core/net/rime/collect.c:898: packetbuf_addr(PACKETBUF_ADDR_ESENDER));
	mov	dpl,#0x1a
	push	ar7
	push	ar6
	push	ar5
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:897: rimeaddr_copy(&recent_packets[recent_packet_ptr].originator,
	mov	dptr,#_recent_packet_ptr
	movx	a,@dptr
	mov	b,#0x06
	mul	ab
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:899: recent_packets[recent_packet_ptr].conn = tc;
	mov	dptr,#_recent_packet_ptr
	movx	a,@dptr
	mov	b,#0x06
	mul	ab
	...
	inc	dptr
	movx	@dptr,a
;	../../core/net/rime/collect.c:900: recent_packet_ptr = (recent_packet_ptr + 1) % NUM_RECENT_PACKETS;
	mov	dptr,#_recent_packet_ptr
	movx	a,@dptr
	mov	r6,a
	mov	r5,#0x00
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:905: node_packet_received(struct unicast_conn *c, const rimeaddr_t *from)
;	-----------------------------------------
...
_node_packet_received:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:907: struct collect_conn *tc = (struct collect_conn *)
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	@r0,ar5
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/rime/collect.c:911: uint8_t ackflags = 0;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	@r0,#0x00
;	../../core/net/rime/collect.c:914: memcpy(&hdr, packetbuf_dataptr(), sizeof(struct data_msg_hdr));
	lcall	_packetbuf_dataptr
	mov	r2,dpl
	mov	r3,dph
	mov	r4,b
	...
	add	a,#0xfb
	mov	sp,a
;	../../core/net/rime/collect.c:921: packetbuf_addr(PACKETBUF_ADDR_SENDER));
	mov	dpl,#0x18
	lcall	_packetbuf_addr
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:920: n = collect_neighbor_list_find(&tc->neighbor_list,
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	a,#0x55
	...
	mov	ar3,r6
	mov	ar4,r7
;	../../core/net/rime/collect.c:922: if(n != NULL) {
	mov	a,r5
	orl	a,r6
	jz	00102$
;	../../core/net/rime/collect.c:923: collect_neighbor_update_rtmetric(n, hdr.rtmetric);
	mov	a,sp
	add	a,#0xeb
	mov	r0,a
	mov	a,#0x02
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:924: update_rtmetric(tc);
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	dpl,@r0
	...
	lcall	_update_rtmetric
00102$:
;	../../core/net/rime/collect.c:931: if(packetbuf_attr(PACKETBUF_ATTR_PACKET_TYPE) ==
	mov	dpl,#0x0e
	lcall	_packetbuf_attr
	mov	a,dpl
	mov	b,dph
	...
	ljmp	00136$
00219$:
;	../../core/net/rime/collect.c:936: stats.datarecv++;
...
00220$:
	...
	inc	dptr
	movx	@dptr,a
;	../../core/net/rime/collect.c:940: rimeaddr_copy(&ack_to, packetbuf_addr(PACKETBUF_ADDR_SENDER));
	mov	dpl,#0x18
	lcall	_packetbuf_addr
	xch	a,r0
	mov	a,sp
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:941: packet_seqno = packetbuf_attr(PACKETBUF_ATTR_PACKET_ID);
	mov	dpl,#0x0d
	lcall	_packetbuf_attr
	pop	ar4
;	../../core/net/rime/collect.c:948: if(packetqueue_len(&tc->send_queue) >= MAX_SENDING_QUEUE / 2) {
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	a,#0x4f
	...
	subb	a,#0x80
	jc	00148$
;	../../core/net/rime/collect.c:949: ackflags |= ACK_FLAGS_CONGESTED;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	@r0,#0x80
;	../../core/net/rime/collect.c:952: for(i = 0; i < NUM_RECENT_PACKETS; i++) {
00148$:
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	...
	mov	r5,#0x00
00138$:
;	../../core/net/rime/collect.c:953: if(recent_packets[i].conn == tc &&
	push	ar4
	mov	a,r3
	add	a,#_recent_packets
	mov	dpl,a
...
00223$:
	pop	ar4
;	../../core/net/rime/collect.c:954: recent_packets[i].eseqno == packetbuf_attr(PACKETBUF_ATTR_EPACKET_ID) &&
	push	ar4
	mov	a,r3
	add	a,#_recent_packets
	mov	r6,a
...
00225$:
	pop	ar4
;	../../core/net/rime/collect.c:956: packetbuf_addr(PACKETBUF_ADDR_ESENDER))) {
	push	ar4
	mov	dpl,#0x1a
	push	ar7
	push	ar6
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:955: rimeaddr_cmp(&recent_packets[i].originator,
	mov	a,#0x03
	add	a,r6
	mov	r6,a
	clr	a
	...
	orl	a,r7
	jz	00139$
;	../../core/net/rime/collect.c:965: send_ack(tc, &ack_to, ackflags);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	ar5,@r0
	...
	add	a,#0xfb
	mov	sp,a
;	../../core/net/rime/collect.c:966: stats.duprecv++;
...
00227$:
	...
	inc	dptr
	movx	@dptr,a
;	../../core/net/rime/collect.c:967: return;
	ljmp	00140$
00139$:
;	../../core/net/rime/collect.c:952: for(i = 0; i < NUM_RECENT_PACKETS; i++) {
	mov	a,#0x06
...
00228$:
	...
	ljmp	00138$
00229$:
;	../../core/net/rime/collect.c:973: if(tc->rtmetric == RTMETRIC_SINK) {
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	a,#0xa0
	...
	ljmp	00131$
00230$:
;	../../core/net/rime/collect.c:976: add_packet_to_recent_packets(tc);
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	dpl,@r0
...
;	../../core/net/rime/collect.c:980: q = queuebuf_new_from_packetbuf();
	lcall	_queuebuf_new_from_packetbuf
	mov	r7,dpl
	mov	r6,dph
	mov	r5,b
	pop	ar4
;	../../core/net/rime/collect.c:981: if(q != NULL) {
	mov	a,r7
	orl	a,r6
	jz	00113$
;	../../core/net/rime/collect.c:982: send_ack(tc, &ack_to, 0);
	mov	ar3,r4
	mov	r4,#0x00
	mov	r2,#0x40
	push	ar7
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:983: queuebuf_to_packetbuf(q);
	mov	dpl,r7
	mov	dph,r6
	mov	b,r5
	push	ar7
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:984: queuebuf_free(q);
	mov	dpl,r7
	mov	dph,r6
	mov	b,r5
	...
	sjmp	00114$
00113$:
;	../../core/net/rime/collect.c:990: stats.ackdrop++;
...
00232$:
	...
	movx	@dptr,a
00114$:
;	../../core/net/rime/collect.c:1001: packetbuf_hdrreduce(sizeof(struct data_msg_hdr));
	mov	dptr,#0x0004
	lcall	_packetbuf_hdrreduce
;	../../core/net/rime/collect.c:1003: if(packetbuf_datalen() > 0 && tc->cb->recv != NULL) {
	lcall	_packetbuf_datalen
	mov	a,dpl
	mov	b,dph
	orl	a,b
...
00233$:
	...
	orl	a,r7
	jz	00116$
;	../../core/net/rime/collect.c:1006: packetbuf_attr(PACKETBUF_ATTR_HOPS));
	mov	dpl,#0x13
	push	ar7
	push	ar6
	lcall	_packetbuf_attr
	mov	r2,dpl
	mov	ar5,r2
;	../../core/net/rime/collect.c:1005: packetbuf_attr(PACKETBUF_ATTR_EPACKET_ID),
	mov	dpl,#0x15
	push	ar5
	lcall	_packetbuf_attr
	mov	r2,dpl
;	../../core/net/rime/collect.c:1004: tc->cb->recv(packetbuf_addr(PACKETBUF_ADDR_ESENDER),
	mov	dpl,#0x1a
	push	ar2
	lcall	_packetbuf_addr
	xch	a,r0
...
00236$:
	...
	pop	ar7
00116$:
;	../../core/net/rime/collect.c:1008: return;
	ljmp	00140$
00131$:
;	../../core/net/rime/collect.c:1009: } else if(packetbuf_attr(PACKETBUF_ATTR_TTL) > 1 &&
	mov	dpl,#0x14
	push	ar7
	push	ar6
	push	ar5
	...
	ljmp	00127$
00237$:
;	../../core/net/rime/collect.c:1010: tc->rtmetric != RTMETRIC_MAX) {
	mov	dpl,r6
	mov	dph,r5
	mov	b,r7
	lcall	__gptrget
	...
	ljmp	00127$
00238$:
;	../../core/net/rime/collect.c:1019: if(hdr.rtmetric <= tc->rtmetric) {
	mov	a,sp
	add	a,#0xeb
	mov	r0,a
	mov	a,#0x02
	...
	subb	a,r5
	jc	00119$
;	../../core/net/rime/collect.c:1020: ackflags |= ACK_FLAGS_RTMETRIC_NEEDS_UPDATE;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,@r0
	...
	mov	@r0,a
00119$:
;	../../core/net/rime/collect.c:1024: packetbuf_attr(PACKETBUF_ATTR_HOPS) + 1);
	mov	dpl,#0x13
	push	ar4
	lcall	_packetbuf_attr
	mov	r6,dpl
	...
	inc	r7
00240$:
;	../../core/net/rime/collect.c:1023: packetbuf_set_attr(PACKETBUF_ATTR_HOPS,
	push	ar4
	push	ar6
	push	ar7
	mov	dpl,#0x13
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1026: packetbuf_attr(PACKETBUF_ATTR_TTL) - 1);
	mov	dpl,#0x14
	lcall	_packetbuf_attr
	mov	r6,dpl
	mov	r7,dph
	...
	dec	r7
00241$:
;	../../core/net/rime/collect.c:1025: packetbuf_set_attr(PACKETBUF_ATTR_TTL,
	push	ar4
	push	ar6
	push	ar7
	mov	dpl,#0x14
	...
	dec	sp
	pop	ar4
;	../../core/net/rime/collect.c:1043: if(packetqueue_len(&tc->send_queue) <= MAX_SENDING_QUEUE - MIN_AVAILABLE_QUEUE_ENTRIES &&
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	a,#0x4f
	...
	ljmp	00121$
00242$:
;	../../core/net/rime/collect.c:1047: tc)) {
	push	ar4
	mov	a,sp
	add	a,#0xf4
	mov	r0,a
	...
	inc	r0
	mov	ar7,@r0
;	../../core/net/rime/collect.c:1046: packetbuf_attr(PACKETBUF_ATTR_MAX_REXMIT),
	mov	dpl,#0x10
	push	ar7
	push	ar6
	push	ar5
	...
	inc	r0
	mov	@r0,ar3
;	../../core/net/rime/collect.c:1044: packetqueue_enqueue_packetbuf(&tc->send_queue,
	mov	a,sp
	add	a,#0xf4
	mov	r0,a
	mov	a,#0x4f
	...
	orl	a,r7
	jz	00121$
;	../../core/net/rime/collect.c:1048: add_packet_to_recent_packets(tc);
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	dpl,@r0
	...
	lcall	_add_packet_to_recent_packets
	pop	ar4
;	../../core/net/rime/collect.c:1049: send_ack(tc, &ack_to, ackflags);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	ar6,@r0
	...
	mov	a,sp
	add	a,#0xfb
;	../../core/net/rime/collect.c:1050: send_queued_packet(tc);
	mov	sp,a
	add	a,#0xf5
	mov	r0,a
	mov	dpl,@r0
	...
	ljmp	00137$
00121$:
;	../../core/net/rime/collect.c:1053: ackflags | ACK_FLAGS_DROPPED | ACK_FLAGS_CONGESTED);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xc0
	...
	mov	r7,a
	mov	r6,#0x00
;	../../core/net/rime/collect.c:1052: send_ack(tc, &ack_to,
	mov	ar5,r4
	mov	r3,#0x00
	mov	r2,#0x40
	push	ar7
	...
	add	a,#0xfb
	mov	sp,a
;	../../core/net/rime/collect.c:1056: stats.qdrop++;
...
00244$:
	...
	ljmp	00137$
00127$:
;	../../core/net/rime/collect.c:1058: } else if(packetbuf_attr(PACKETBUF_ATTR_TTL) <= 1) {
	mov	dpl,#0x14
	push	ar4
	lcall	_packetbuf_attr
	mov	r6,dpl
	...
	ljmp	00137$
00245$:
;	../../core/net/rime/collect.c:1063: ACK_FLAGS_DROPPED | ACK_FLAGS_LIFETIME_EXCEEDED);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x60
	...
	mov	r7,a
	mov	r6,#0x00
;	../../core/net/rime/collect.c:1062: send_ack(tc, &ack_to, ackflags |
	mov	r5,#0x00
	mov	r3,#0x40
	push	ar7
	push	ar6
	...
	add	a,#0xfb
	mov	sp,a
;	../../core/net/rime/collect.c:1064: stats.ttldrop++;
...
00246$:
	...
	sjmp	00137$
00136$:
;	../../core/net/rime/collect.c:1066: } else if(packetbuf_attr(PACKETBUF_ATTR_PACKET_TYPE) ==
	mov	dpl,#0x0e
	lcall	_packetbuf_attr
	mov	r6,dpl
	mov	r7,dph
	cjne	r6,#0x01,00137$
	cjne	r7,#0x00,00137$
;	../../core/net/rime/collect.c:1076: handle_ack(tc);
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_handle_ack
;	../../core/net/rime/collect.c:1077: stats.ackrecv++;
	mov	dptr,#(_stats + 0x0018)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
00249$:
	...
	movx	@dptr,a
00137$:
;	../../core/net/rime/collect.c:1079: return;
00140$:
;	../../core/net/rime/collect.c:1080: }
	mov	a,sp
	add	a,#0xea
	mov	sp,a
	ret
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1083: timedout(struct collect_conn *tc)
;	-----------------------------------------
;	 function timedout
;	-----------------------------------------
_timedout:
	...
	mov	a,sp
	add	a,#0x0d
;	../../core/net/rime/collect.c:1093: tc->max_rexmits);
	mov	sp,a
	add	a,#0xf1
	mov	r0,a
	mov	a,#0xa5
	...
	inc	r0
	mov	@r0,#0x00
;	../../core/net/rime/collect.c:1092: tc->current_parent.u8[0], tc->current_parent.u8[1],
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	a,#0x9e
...
00109$:
	...
	inc	r0
	mov	@r0,#0x00
;	../../core/net/rime/collect.c:1091: rimeaddr_node_addr.u8[0], rimeaddr_node_addr.u8[1], tc->transmissions,
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	a,#0xa4
	...
	mov	r5,a
	mov	r7,#0x00
;	../../core/net/rime/collect.c:1090: printf("%d.%d: timedout after %d retransmissions to %d.%d (max retransmissions %d): packet dropped\n",
	push	ar4
	push	ar3
	push	ar2
	mov	a,sp
	...
	pop	ar3
	pop	ar4
;	../../core/net/rime/collect.c:1095: tc->sending = 0;
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	a,#0xa3
	...
	clr	a
	lcall	__gptrput
;	../../core/net/rime/collect.c:1097: &tc->current_parent);
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	r1,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../core/net/rime/collect.c:1096: n = collect_neighbor_list_find(&tc->neighbor_list,
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	a,#0x55
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/rime/collect.c:1098: if(n != NULL) {
	mov	a,r5
	orl	a,r6
	jz	00102$
;	../../core/net/rime/collect.c:1099: collect_neighbor_tx_fail(n, tc->max_rexmits);
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	__gptrget
	...
	dec	sp
00102$:
;	../../core/net/rime/collect.c:1101: update_rtmetric(tc);
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_update_rtmetric
;	../../core/net/rime/collect.c:1102: send_next_packet(tc);
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_send_next_packet
;	../../core/net/rime/collect.c:1103: set_keepalive_timer(tc);
	mov	a,sp
	add	a,#0xf1
	mov	r0,a
	mov	dpl,@r0
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1107: node_packet_sent(struct unicast_conn *c, int status, int transmissions)
;	-----------------------------------------
...
_node_packet_sent:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1109: struct collect_conn *tc = (struct collect_conn *)
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	@r0,ar5
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/rime/collect.c:1113: if(packetbuf_attr(PACKETBUF_ATTR_PACKET_TYPE) ==
	mov	dpl,#0x0e
	lcall	_packetbuf_attr
	mov	a,dpl
	mov	b,dph
	...
	ljmp	00106$
00116$:
;	../../core/net/rime/collect.c:1116: tc->transmissions += transmissions;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0xa4
	...
	mov	b,r4
	lcall	__gptrput
;	../../core/net/rime/collect.c:1123: if(tc->transmissions >= tc->max_rexmits) {
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	__gptrget
	...
	subb	a,r5
	jc	00102$
;	../../core/net/rime/collect.c:1124: timedout(tc);
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_timedout
;	../../core/net/rime/collect.c:1125: stats.timedout++;
...
00118$:
	...
	sjmp	00106$
00102$:
;	../../core/net/rime/collect.c:1127: clock_time_t time = REXMIT_TIME / 2 + (random_rand() % (REXMIT_TIME / 2));
	lcall	_random_rand
	mov	r6,dpl
	mov	r7,#0x00
	mov	a,#0x01
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/rime/collect.c:1130: retransmit_callback, tc);
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	ar3,@r0
	...
	inc	r0
	mov	ar5,@r0
;	../../core/net/rime/collect.c:1129: ctimer_set(&tc->retransmission_timer, time,
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x34
...
;c                         Allocated to stack - sp -2
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1144: retransmit_not_sent_callback(void *ptr)
;	-----------------------------------------
...
_retransmit_not_sent_callback:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1146: struct collect_conn *c = ptr;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	@r0,ar5
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/rime/collect.c:1149: c->transmissions += MAX_MAC_REXMITS + 1;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa4
	...
	mov	a,r7
	lcall	__gptrput
;	../../core/net/rime/collect.c:1150: retransmit_callback(c);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	ar5,@r0
...
;c                         Allocated to stack - sp -2
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1161: retransmit_callback(void *ptr)
;	-----------------------------------------
...
_retransmit_callback:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1163: struct collect_conn *c = ptr;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	@r0,ar5
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/rime/collect.c:1166: if(c->transmissions >= c->max_rexmits) {
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa4
	...
	subb	a,r3
	jc	00102$
;	../../core/net/rime/collect.c:1167: timedout(c);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_timedout
;	../../core/net/rime/collect.c:1168: stats.timedout++;
	mov	dptr,#(_stats + 0x0034)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
00111$:
	...
	sjmp	00104$
00102$:
;	../../core/net/rime/collect.c:1170: c->sending = 0;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa3
	...
	clr	a
	lcall	__gptrput
;	../../core/net/rime/collect.c:1171: retransmit_current_packet(c);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1214: received_announcement(struct announcement *a, const rimeaddr_t *from,
;	-----------------------------------------
...
_received_announcement:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1217: struct collect_conn *tc = (struct collect_conn *)
	mov	a,r5
	add	a,#0xee
	mov	r5,a
	mov	a,r6
	...
	inc	r0
	mov	@r0,ar7
;	../../core/net/rime/collect.c:1221: n = collect_neighbor_list_find(&tc->neighbor_list, from);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x55
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1223: if(n == NULL) {
	mov	a,r2
	orl	a,r3
	jz	00149$
	ljmp	00110$
00149$:
;	../../core/net/rime/collect.c:1226: if(value < tc->rtmetric) {
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa0
	...
	subb	a,r7
	jnc	00102$
;	../../core/net/rime/collect.c:1227: collect_neighbor_list_add(&tc->neighbor_list, from, value);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x55
	...
	pop	ar4
00102$:
;	../../core/net/rime/collect.c:1232: if(value == RTMETRIC_MAX && tc->rtmetric != RTMETRIC_MAX) {
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	ar6,@r0
...
00152$:
	...
	ljmp	00111$
00153$:
;	../../core/net/rime/collect.c:1233: bump_advertisement(tc);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
	...
	sjmp	00111$
00110$:
;	../../core/net/rime/collect.c:1244: if(value == RTMETRIC_MAX &&
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	ar6,@r0
	...
	cjne	r6,#0xff,00107$
	cjne	r7,#0x01,00107$
;	../../core/net/rime/collect.c:1245: collect_neighbor_rtmetric(n) != RTMETRIC_MAX) {
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	push	ar4
	...
	sjmp	00107$
00156$:
;	../../core/net/rime/collect.c:1246: bump_advertisement(tc);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
	...
	pop	ar4
00107$:
;	../../core/net/rime/collect.c:1248: collect_neighbor_update_rtmetric(n, value);
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	a,@r0
	...
	dec	sp
00111$:
;	../../core/net/rime/collect.c:1254: update_rtmetric(tc);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_update_rtmetric
;	../../core/net/rime/collect.c:1257: if(value == RTMETRIC_MAX &&
	mov	a,sp
	add	a,#0xf5
	mov	r0,a
	mov	ar6,@r0
	...
	cjne	r6,#0xff,00115$
	cjne	r7,#0x01,00115$
;	../../core/net/rime/collect.c:1258: tc->rtmetric != RTMETRIC_MAX) {
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa0
	...
	sjmp	00115$
00159$:
;	../../core/net/rime/collect.c:1259: announcement_bump(&tc->announcement);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x12
...
;sloc0                     Allocated to stack - sp -1
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1273: collect_open(struct collect_conn *tc, uint16_t channels,
;	-----------------------------------------
...
_collect_open:
	...
	inc	sp
	inc	sp
;	../../core/net/rime/collect.c:1277: unicast_open(&tc->unicast_conn, channels + 1, &unicast_callbacks);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	ar3,@r0
...
00106$:
	...
	pop	ar3
	pop	ar4
;	../../core/net/rime/collect.c:1278: channel_set_attributes(channels + 1, attributes);
	mov	a,#_attributes
	push	acc
	mov	a,#(_attributes >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1279: tc->rtmetric = RTMETRIC_MAX;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0xa0
	...
	mov	a,#0x01
	lcall	__gptrput
;	../../core/net/rime/collect.c:1280: tc->cb = cb;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x31
	...
	mov	a,@r0
	lcall	__gptrput
;	../../core/net/rime/collect.c:1281: tc->is_router = is_router;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0xa7
	...
	mov	a,@r0
	lcall	__gptrput
;	../../core/net/rime/collect.c:1282: tc->seqno = 10;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0xa2
	...
	mov	a,#0x0a
	lcall	__gptrput
;	../../core/net/rime/collect.c:1283: tc->eseqno = 0;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0xa6
	...
	clr	a
	lcall	__gptrput
;	../../core/net/rime/collect.c:1284: LIST_STRUCT_INIT(tc, send_queue_list);
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x4c
	...
	pop	ar3
	pop	ar4
;	../../core/net/rime/collect.c:1285: collect_neighbor_list_new(&tc->neighbor_list);
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x55
	...
	pop	ar3
	pop	ar4
;	../../core/net/rime/collect.c:1286: tc->send_queue.list = &(tc->send_queue_list);
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x4f
	...
	mov	a,r4
	lcall	__gptrput
;	../../core/net/rime/collect.c:1287: tc->send_queue.memb = &send_queue_memb;
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x4f
	...
	clr	a
	lcall	__gptrput
;	../../core/net/rime/collect.c:1288: collect_neighbor_init();
	lcall	_collect_neighbor_init
;	../../core/net/rime/collect.c:1302: announcement_register(&tc->announcement, channels,
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x12
	...
	mov	a,sp
	add	a,#0xfc
;	../../core/net/rime/collect.c:1305: announcement_set_value(&tc->announcement, RTMETRIC_MAX);
	mov	sp,a
	add	a,#0xfc
	mov	r0,a
	mov	a,#0x12
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1310: proactive_probing_callback, tc);
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	ar5,@r0
	...
	inc	r0
	mov	ar7,@r0
;	../../core/net/rime/collect.c:1309: ctimer_set(&tc->proactive_probing_timer, PROACTIVE_PROBING_INTERVAL,
	push	ar7
	push	ar6
	push	ar5
	lcall	_random_rand
...
;c                         Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1315: send_keepalive(void *ptr)
;	-----------------------------------------
;	 function send_keepalive
;	-----------------------------------------
_send_keepalive:
;	../../core/net/rime/collect.c:1317: struct collect_conn *c = ptr;
;	../../core/net/rime/collect.c:1319: set_keepalive_timer(c);
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
	push	ar7
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:1322: if(c->sending == 0 && packetqueue_len(&c->send_queue) == 0) {
	mov	a,#0xa3
	add	a,r5
	mov	r2,a
	clr	a
	...
	orl	a,b
	jnz	00106$
;	../../core/net/rime/collect.c:1323: if(enqueue_dummy_packet(c, KEEPALIVE_REXMITS)) {
	push	ar7
	push	ar6
	push	ar5
	mov	a,#0x08
	...
	orl	a,r4
	jz	00106$
;	../../core/net/rime/collect.c:1326: send_queued_packet(c);
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
;	../../core/net/rime/collect.c:1329: }
	ljmp	_send_queued_packet
00106$:
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1332: set_keepalive_timer(struct collect_conn *c)
;	-----------------------------------------
...
_set_keepalive_timer:
	...
	mov	a,sp
	add	a,#0x05
;	../../core/net/rime/collect.c:1334: if(c->keepalive_period != 0) {
	mov	sp,a
	add	a,#0xf9
	mov	r0,a
	mov	a,#0x85
	...
	ljmp	00102$
00110$:
;	../../core/net/rime/collect.c:1337: send_keepalive, c);
	mov	a,sp
	add	a,#0xf9
	mov	r0,a
	mov	r1,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../core/net/rime/collect.c:1335: ctimer_set(&c->keepalive_timer, (c->keepalive_period / 2) +
	mov	a,sp
	add	a,#0xfc
	mov	r0,a
	mov	@r0,ar6
	...
	inc	r0
	mov	@r0,a
;	../../core/net/rime/collect.c:1336: (random_rand() % (c->keepalive_period / 2)),
	push	ar4
	push	ar3
	push	ar2
	lcall	_random_rand
...
;	../../core/net/rime/collect.c:1335: ctimer_set(&c->keepalive_timer, (c->keepalive_period / 2) +
	...
	sjmp	00104$
00102$:
;	../../core/net/rime/collect.c:1339: ctimer_stop(&c->keepalive_timer);
	mov	a,sp
	add	a,#0xf9
	mov	r0,a
	mov	a,#0x70
...
;c                         Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1344: collect_set_keepalive(struct collect_conn *c, clock_time_t period)
;	-----------------------------------------
...
_collect_set_keepalive:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1346: c->keepalive_period = period;
	mov	a,#0x85
	add	a,r5
	mov	r2,a
	clr	a
	...
	mov	a,@r0
	lcall	__gptrput
;	../../core/net/rime/collect.c:1347: set_keepalive_timer(c);
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
;	../../core/net/rime/collect.c:1348: }
...
;tc                        Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1351: collect_close(struct collect_conn *tc)
;	-----------------------------------------
...
_collect_close:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1354: announcement_remove(&tc->announcement);
	mov	a,#0x12
	add	a,r5
	mov	r2,a
	clr	a
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:1358: unicast_close(&tc->unicast_conn);
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	push	ar7
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:1359: while(packetqueue_first(&tc->send_queue) != NULL) {
00101$:
	mov	a,#0x4f
	add	a,r5
	mov	r2,a
	...
	orl	a,r3
	jz	00104$
;	../../core/net/rime/collect.c:1360: packetqueue_dequeue(&tc->send_queue);
	mov	a,#0x4f
	add	a,r5
	mov	r2,a
	clr	a
...
;tc                        Allocated to stack - sp -2
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1365: collect_set_sink(struct collect_conn *tc, int should_be_sink)
;	-----------------------------------------
...
_collect_set_sink:
	...
	push	dph
	push	b
;	../../core/net/rime/collect.c:1367: if(should_be_sink) {
	mov	a,sp
	add	a,#0xfa
	mov	r0,a
	mov	a,@r0
	...
	ljmp	00105$
00123$:
;	../../core/net/rime/collect.c:1368: tc->is_router = 1;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa7
	...
	mov	a,#0x01
	lcall	__gptrput
;	../../core/net/rime/collect.c:1369: tc->rtmetric = RTMETRIC_SINK;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa0
	...
	inc	dptr
	lcall	__gptrput
;	../../core/net/rime/collect.c:1371: bump_advertisement(tc);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_bump_advertisement
;	../../core/net/rime/collect.c:1374: while(packetqueue_len(&tc->send_queue) > 0) {
00101$:
	mov	r0,sp
	dec	r0
	dec	r0
	...
	subb	a,b
	jnc	00103$
;	../../core/net/rime/collect.c:1375: packetqueue_dequeue(&tc->send_queue);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x4f
	...
	sjmp	00101$
00103$:
;	../../core/net/rime/collect.c:1379: ctimer_stop(&tc->retransmission_timer);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x34
	...
	sjmp	00106$
00105$:
;	../../core/net/rime/collect.c:1381: tc->rtmetric = RTMETRIC_MAX;
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa0
	...
	lcall	__gptrput
00106$:
;	../../core/net/rime/collect.c:1384: announcement_set_value(&tc->announcement, tc->rtmetric);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0xa0
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1386: update_rtmetric(tc);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_update_rtmetric
;	../../core/net/rime/collect.c:1388: bump_advertisement(tc);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_bump_advertisement
;	../../core/net/rime/collect.c:1391: printf("#A rt=0,p=0\n");
;	../../core/net/rime/collect.c:1393: }
	dec	sp
	dec	sp
	dec	sp
	ret
...
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1396: collect_send(struct collect_conn *tc, int rexmits)
;	-----------------------------------------
...
_collect_send:
	...
	inc	sp
	inc	sp
;	../../core/net/rime/collect.c:1401: packetbuf_set_attr(PACKETBUF_ATTR_EPACKET_ID, tc->eseqno);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,#0xa6
	...
	pop	ar3
	pop	ar4
;	../../core/net/rime/collect.c:1411: tc->eseqno = (tc->eseqno + 1) % (1 << COLLECT_PACKET_ID_BITS);
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	__gptrget
...
00143$:
	...
	mov	dph,r3
	mov	b,r4
;	../../core/net/rime/collect.c:1413: if(tc->eseqno == 0) {
	mov	a,r6
	lcall	__gptrput
	jnz	00102$
;	../../core/net/rime/collect.c:1414: tc->eseqno = ((int)(1 << COLLECT_PACKET_ID_BITS)) / 2;
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	mov	a,#0x80
	lcall	__gptrput
00102$:
;	../../core/net/rime/collect.c:1416: packetbuf_set_addr(PACKETBUF_ADDR_ESENDER, &rimeaddr_node_addr);
	mov	a,#_rimeaddr_node_addr
	push	acc
	mov	a,#(_rimeaddr_node_addr >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1417: packetbuf_set_attr(PACKETBUF_ATTR_HOPS, 1);
	mov	a,#0x01
	push	acc
	clr	a
	push	acc
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1418: packetbuf_set_attr(PACKETBUF_ATTR_TTL, MAX_HOPLIM);
	mov	a,#0x0f
	push	acc
	clr	a
	push	acc
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1419: if(rexmits > MAX_REXMITS) {
	mov	a,sp
	add	a,#0xf7
	mov	r0,a
	clr	c
	...
	subb	a,b
	jnc	00104$
;	../../core/net/rime/collect.c:1420: packetbuf_set_attr(PACKETBUF_ATTR_MAX_REXMIT, MAX_REXMITS);
	mov	a,#0x1f
	push	acc
	clr	a
	push	acc
	...
	sjmp	00105$
00104$:
;	../../core/net/rime/collect.c:1422: packetbuf_set_attr(PACKETBUF_ATTR_MAX_REXMIT, rexmits);
	mov	a,sp
	add	a,#0xf7
	mov	r0,a
	mov	ar6,@r0
	...
	dec	sp
00105$:
;	../../core/net/rime/collect.c:1430: if(tc->rtmetric == RTMETRIC_SINK) {
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,#0xa0
	...
	ljmp	00115$
00146$:
;	../../core/net/rime/collect.c:1431: packetbuf_set_attr(PACKETBUF_ATTR_HOPS, 0);
	clr	a
	push	acc
	push	acc
	mov	dpl,#0x13
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1432: if(tc->cb->recv != NULL) {
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,#0x31
	...
	orl	a,r6
	jz	00107$
;	../../core/net/rime/collect.c:1435: packetbuf_attr(PACKETBUF_ATTR_HOPS));
	mov	dpl,#0x13
	push	ar7
	push	ar6
	lcall	_packetbuf_attr
	mov	r4,dpl
;	../../core/net/rime/collect.c:1434: packetbuf_attr(PACKETBUF_ATTR_EPACKET_ID),
	mov	dpl,#0x15
	push	ar4
	lcall	_packetbuf_attr
	mov	r3,dpl
	...
	dec	r0
	mov	@r0,ar3
;	../../core/net/rime/collect.c:1433: tc->cb->recv(packetbuf_addr(PACKETBUF_ADDR_ESENDER),
	mov	dpl,#0x1a
	push	ar7
	push	ar6
	push	ar4
...
00149$:
	...
	pop	ar7
00107$:
;	../../core/net/rime/collect.c:1437: return 1;
	mov	dptr,#0x0001
	ljmp	00117$
00115$:
;	../../core/net/rime/collect.c:1441: packetbuf_hdralloc(sizeof(struct data_msg_hdr));
	mov	dptr,#0x0004
	lcall	_packetbuf_hdralloc
;	../../core/net/rime/collect.c:1446: tc)) {
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	ar5,@r0
	...
	inc	r0
	mov	ar7,@r0
;	../../core/net/rime/collect.c:1445: packetbuf_attr(PACKETBUF_ATTR_MAX_REXMIT),
	mov	dpl,#0x10
	push	ar7
	push	ar6
	push	ar5
	...
	inc	r0
	mov	@r0,ar4
;	../../core/net/rime/collect.c:1443: if(packetqueue_enqueue_packetbuf(&tc->send_queue,
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,#0x4f
	...
	orl	a,r7
	jz	00109$
;	../../core/net/rime/collect.c:1447: send_queued_packet(tc);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	dpl,@r0
	...
	mov	b,@r0
	lcall	_send_queued_packet
;	../../core/net/rime/collect.c:1448: ret = 1;
	mov	r6,#0x01
	mov	r7,#0x00
	sjmp	00110$
00109$:
;	../../core/net/rime/collect.c:1453: rimeaddr_node_addr.u8[0], rimeaddr_node_addr.u8[1]);
	mov	dptr,#(_rimeaddr_node_addr + 0x0001)
	movx	a,@dptr
	mov	r5,a
	mov	r4,#0x00
	...
	mov	r3,a
	mov	r2,#0x00
;	../../core/net/rime/collect.c:1452: printf("%d.%d: drop originated packet: no queuebuf\n",
	push	ar5
	push	ar4
	push	ar3
	push	ar2
	...
	add	a,#0xf9
	mov	sp,a
;	../../core/net/rime/collect.c:1454: ret = 0;
	mov	r6,#0x00
	mov	r7,#0x00
00110$:
;	../../core/net/rime/collect.c:1458: n = collect_neighbor_list_find(&tc->neighbor_list, &tc->parent);
	push	ar6
	push	ar7
	mov	a,sp
	add	a,#0xf9
	...
	dec	sp
	dec	sp
;	../../core/net/rime/collect.c:1459: if(n != NULL) {
	mov	a,r5
	orl	a,r6
	pop	ar7
	pop	ar6
	jnz	00116$
;	../../core/net/rime/collect.c:1473: announcement_set_value(&tc->announcement, RTMETRIC_MAX);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,#0x12
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:1474: announcement_bump(&tc->announcement);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,#0x12
	...
	pop	ar7
00116$:
;	../../core/net/rime/collect.c:1491: return ret;
	mov	dpl,r6
	mov	dph,r7
00117$:
;	../../core/net/rime/collect.c:1492: }
	mov	a,sp
	add	a,#0xfa
	mov	sp,a
	ret
...
;tc                        Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1495: collect_depth(struct collect_conn *tc)
;	-----------------------------------------
...
_collect_depth:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1497: return tc->rtmetric;
	mov	a,#0xa0
	add	a,r5
	mov	r5,a
	clr	a
...
;tc                        Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1501: collect_parent(struct collect_conn *tc)
;	-----------------------------------------
...
_collect_parent:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1503: return &tc->current_parent;
	mov	a,#0x9e
	add	a,r5
	mov	r5,a
	clr	a
...
;tc                        Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	../../core/net/rime/collect.c:1507: collect_purge(struct collect_conn *tc)
;	-----------------------------------------
...
_collect_purge:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/rime/collect.c:1509: collect_neighbor_list_purge(&tc->neighbor_list);
	mov	a,#0x55
	add	a,r5
	mov	r2,a
	clr	a
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:1510: rimeaddr_copy(&tc->parent, &rimeaddr_null);
	mov	a,#0x9c
	add	a,r5
	mov	r2,a
	clr	a
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:1511: update_rtmetric(tc);
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	push	ar7
	...
	pop	ar6
	pop	ar7
;	../../core/net/rime/collect.c:1515: rimeaddr_copy(&tc->parent, &rimeaddr_null);
	mov	a,#0x9c
	add	a,r5
	mov	r5,a
	clr	a
