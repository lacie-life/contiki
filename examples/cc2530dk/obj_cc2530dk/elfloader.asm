...
;------------------------------------------------------------
;section                   Allocated to stack - sp -81
;size                      Allocated to stack - sp -83
;sectionaddr               Allocated to stack - sp -85
;sectionbase               Allocated to stack - sp -88
;strs                      Allocated to stack - sp -90
;strtab                    Allocated to stack - sp -92
;symtab                    Allocated to stack - sp -94
;symtabsize                Allocated to stack - sp -96
;using_relas               Allocated to stack - sp -97
...
;ehdr                      Allocated to stack - sp -74
;shdr                      Allocated to stack - sp -154
;strtable                  Allocated to stack - sp -114
;strs                      Allocated to stack - sp -168
;shdrptr                   Allocated to stack - sp -22
