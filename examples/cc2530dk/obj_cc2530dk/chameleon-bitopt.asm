...
;------------------------------------------------------------
;	../../core/net/rime/chameleon-bitopt.c:73: get_bits_in_byte(uint8_t *from, uint16_t bitpos, uint16_t vallen)
;	-----------------------------------------
...
00107$:
	djnz	b,00106$
	mov	dpl,r4
;	../../core/net/rime/chameleon-bitopt.c:86: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'get_bits'
;------------------------------------------------------------
;from                      Allocated to stack - sp -16
;bitpos                    Allocated to stack - sp -18
;vallen                    Allocated to stack - sp -20
...
;------------------------------------------------------------
;	../../core/net/rime/chameleon-bitopt.c:89: get_bits(uint8_t *to, uint8_t *from, uint16_t bitpos, uint16_t vallen)
;	-----------------------------------------
;	 function get_bits
;	-----------------------------------------
_get_bits:
...
;	../../core/net/rime/chameleon-bitopt.c:115: to[i] = get_bits_in_byte(&from[i], bitpos, bits);
	...
	lcall	__gptrput
00119$:
;	../../core/net/rime/chameleon-bitopt.c:119: }
	mov	a,sp
	add	a,#0xf4
	mov	sp,a
	ret
...
;	../../core/net/rime/chameleon-bitopt.c:146: return size;
	...
	inc	r0
	mov	dph,@r0
;	../../core/net/rime/chameleon-bitopt.c:147: }
	dec	sp
	dec	sp
	ret
;------------------------------------------------------------
...
;val                       Allocated to stack - sp -7
;vallen                    Allocated to stack - sp -9
;target                    Allocated to stack - sp -2
...
;	../../core/net/rime/chameleon-bitopt.c:157: target[1] |= shifted_val & 0xff;
	...
	mov	a,r2
	lcall	__gptrput
;	../../core/net/rime/chameleon-bitopt.c:158: }
	dec	sp
	dec	sp
	dec	sp
	ret
...
;------------------------------------------------------------
;bitpos                    Allocated to stack - sp -15
;val                       Allocated to stack - sp -18
;vallen                    Allocated to stack - sp -20
...
;sloc1                     Allocated to stack - sp -6
;------------------------------------------------------------
;	../../core/net/rime/chameleon-bitopt.c:161: set_bits(uint8_t *ptr, int bitpos, uint8_t *val, uint16_t vallen)
;	-----------------------------------------
;	 function set_bits
;	-----------------------------------------
_set_bits:
...
00174$:
	...
	mov	sp,a
00119$:
;	../../core/net/rime/chameleon-bitopt.c:193: }
	mov	a,sp
	add	a,#0xf4
	mov	sp,a
	ret
...
;	../../core/net/rime/chameleon-bitopt.c:295: return 1; /* Send out packet */
	mov	dptr,#0x0001
00110$:
;	../../core/net/rime/chameleon-bitopt.c:296: }
	mov	a,sp
	add	a,#0xe9
	mov	sp,a
	ret
...
;	../../core/net/rime/chameleon-bitopt.c:363: return c;
	...
	mov	b,@r0
00114$:
;	../../core/net/rime/chameleon-bitopt.c:364: }
	xch	a,r0
	mov	a,sp
	add	a,#0xea
	mov	sp,a
