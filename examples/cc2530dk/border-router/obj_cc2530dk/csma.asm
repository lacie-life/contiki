...
_mac_status:
	.ds 2
_packet_sent_cb_sent_65536_196:
	.ds 3
_packet_sent_cb_cptr_65536_196:
	.ds 3
_packet_sent_cb_num_tx_65536_196:
	.ds 2
_send_packet_addr_131072_212:
	.ds 3
;--------------------------------------------------------
...
;------------------------------------------------------------
;status                    Allocated to stack - sp -19
;ptr                       Allocated to registers r5 r6 r7 
;n                         Allocated to stack - sp -7
;q                         Allocated to stack - sp -10
...
;sent                      Allocated with name '_packet_sent_cb_sent_65536_196'
;cptr                      Allocated with name '_packet_sent_cb_cptr_65536_196'
;num_tx                    Allocated with name '_packet_sent_cb_num_tx_65536_196'
;------------------------------------------------------------
...
;	../../../core/net/mac/csma.c:236: sent = metadata->sent;
	...
	lcall	__gptrget
	mov	r7,a
	mov	dptr,#_packet_sent_cb_sent_65536_196
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;	../../../core/net/mac/csma.c:237: cptr = metadata->cptr;
	...
	lcall	__gptrget
	mov	r7,a
	mov	dptr,#_packet_sent_cb_cptr_65536_196
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
...
;	../../../core/net/mac/csma.c:238: num_tx = n->transmissions;
	...
	lcall	__gptrget
	mov	r4,a
	mov	dptr,#_packet_sent_cb_num_tx_65536_196
	movx	@dptr,a
	clr	a
	inc	dptr
	movx	@dptr,a
...
;addr                      Allocated with name '_send_packet_addr_131072_212'
;------------------------------------------------------------
...
;	../../../core/net/mac/csma.c:310: addr = packetbuf_addr(PACKETBUF_ADDR_RECEIVER);
	...
	mov	r3,dph
	mov	r4,b
	mov	dptr,#_send_packet_addr_131072_212
	mov	a,r2
	movx	@dptr,a
	mov	a,r3
	inc	dptr
