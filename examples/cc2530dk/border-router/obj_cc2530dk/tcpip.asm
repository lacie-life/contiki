...
_outputfunc:
	.ds 3
_eventhandler_p_65536_552:
	.ds 3
_tcpip_ipv6_output_nbr_65536_566:
	.ds 3
_tcpip_ipv6_output_nexthop_65536_566:
	.ds 3
_tcpip_uipcall_ts_65536_590:
	.ds 3
;--------------------------------------------------------
...
;nbr                       Allocated with name '_tcpip_ipv6_output_nbr_65536_566'
;nexthop                   Allocated with name '_tcpip_ipv6_output_nexthop_65536_566'
;------------------------------------------------------------
;	../../../core/net/tcpip.c:548: static uip_ds6_nbr_t *nbr = NULL;
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_566
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;p                         Allocated with name '_eventhandler_p_65536_552'
;------------------------------------------------------------
...
;	../../../core/net/tcpip.c:384: p = (struct process *)data;
	...
	add	a,#0xfb
	mov	r0,a
	mov	dptr,#_eventhandler_p_65536_552
	mov	a,@r0
	movx	@dptr,a
	inc	r0
	mov	a,@r0
...
;	-----------------------------------------
_tcpip_input:
;	../../../core/net/tcpip.c:534: packet_input();
	mov	r0,#_packet_input
	mov	r1,#(_packet_input >> 8)
	mov	r2,#(_packet_input >> 16)
	lcall	__sdcc_banked_call
;	../../../core/net/tcpip.c:538: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:540: uip_ext_len = 0;
	mov	dptr,#_uip_ext_len
	movx	@dptr,a
;	../../../core/net/tcpip.c:542: }
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'tcpip_ipv6_output'
;------------------------------------------------------------
...
;nexthop                   Allocated with name '_tcpip_ipv6_output_nexthop_65536_566'
;------------------------------------------------------------
;	../../../core/net/tcpip.c:546: tcpip_ipv6_output(void)
;	-----------------------------------------
...
_tcpip_ipv6_output:
	...
	add	a,#0x04
	mov	sp,a
;	../../../core/net/tcpip.c:551: if(uip_len == 0) {
	mov	dptr,#_uip_len
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	orl	a,b
	jnz	00102$
;	../../../core/net/tcpip.c:552: return;
	ljmp	00141$
00102$:
;	../../../core/net/tcpip.c:555: if(uip_len > UIP_LINK_MTU) {
	clr	c
	clr	a
	subb	a,r6
	mov	a,#0x05
	subb	a,r7
	jnc	00104$
;	../../../core/net/tcpip.c:557: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:558: return;
	ljmp	00141$
00104$:
;	../../../core/net/tcpip.c:561: if(uip_is_addr_unspecified(&UIP_IP_BUF->destipaddr)){
	...
	orl	a,r6
	jnz	00106$
;	../../../core/net/tcpip.c:563: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:564: return;
	ljmp	00141$
00106$:
;	../../../core/net/tcpip.c:567: if(!uip_is_addr_mcast(&UIP_IP_BUF->destipaddr)) {
	mov	dptr,#(_uip_aligned_buf + 0x0018)
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0xff,00237$
...
;	../../../core/net/tcpip.c:569: nbr = NULL;
	...
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:570: if(uip_ds6_is_addr_onlink(&UIP_IP_BUF->destipaddr)){
	mov	dptr,#(_uip_aligned_buf + 0x0018)
	mov	b,#0x00
	...
	mov	a,dpl
	jz	00122$
;	../../../core/net/tcpip.c:571: nexthop = &UIP_IP_BUF->destipaddr;
	mov	dptr,#_tcpip_ipv6_output_nexthop_65536_566
	...
	ljmp	00123$
00122$:
;	../../../core/net/tcpip.c:574: locrt = uip_ds6_route_lookup(&UIP_IP_BUF->destipaddr);
	mov	dptr,#(_uip_aligned_buf + 0x0018)
	mov	b,#0x00
	...
	mov	ar3,r6
	mov	ar4,r7
;	../../../core/net/tcpip.c:575: if(locrt == NULL) {
	mov	a,r5
	orl	a,r6
	jnz	00119$
;	../../../core/net/tcpip.c:576: if((nexthop = uip_ds6_defrt_choose()) == NULL) {
	...
	orl	a,r6
	jnz	00123$
;	../../../core/net/tcpip.c:580: if(uip_ext_len > 0) {
	mov	dptr,#_uip_ext_len
	movx	a,@dptr
	jz	00115$
;	../../../core/net/tcpip.c:582: uint8_t proto = *((uint8_t *)UIP_IP_BUF + 40);
	mov	dptr,#(_uip_aligned_buf + 0x0028)
	mov	b,#0x00
	lcall	__gptrget
	mov	r7,a
;	../../../core/net/tcpip.c:583: remove_ext_hdr();
	push	ar7
	...
	lcall	__sdcc_banked_call
	pop	ar7
;	../../../core/net/tcpip.c:585: UIP_IP_BUF->proto = proto;
	mov	dptr,#(_uip_aligned_buf + 0x0006)
	mov	a,r7
	movx	@dptr,a
00115$:
;	../../../core/net/tcpip.c:587: UIP_FALLBACK_INTERFACE.output();
	mov	dptr,#(_slip_interface + 0x0003)
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	movx	a,@dptr
	...
	pop	ar6
	pop	ar7
;	../../../core/net/tcpip.c:591: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:592: return;
	ljmp	00141$
00119$:
;	../../../core/net/tcpip.c:595: nexthop = &locrt->nexthop;
	mov	dptr,#_tcpip_ipv6_output_nexthop_65536_566
	mov	a,#0x13
	add	a,r2
	movx	@dptr,a
	...
	movx	@dptr,a
00123$:
;	../../../core/net/tcpip.c:605: if(rpl_update_header_final(nexthop)) {
	mov	dptr,#_tcpip_ipv6_output_nexthop_65536_566
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	orl	a,b
	jz	00125$
;	../../../core/net/tcpip.c:606: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:607: return;
	ljmp	00141$
00125$:
;	../../../core/net/tcpip.c:610: if((nbr = uip_ds6_nbr_lookup(nexthop)) == NULL) {
	mov	dptr,#_tcpip_ipv6_output_nexthop_65536_566
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	ljmp	00137$
00243$:
;	../../../core/net/tcpip.c:611: if((nbr = uip_ds6_nbr_add(nexthop, NULL, 0, NBR_INCOMPLETE)) == NULL) {
	mov	dptr,#_tcpip_ipv6_output_nexthop_65536_566
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	orl	a,r3
	jnz	00130$
;	../../../core/net/tcpip.c:612: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:613: return;
	ljmp	00141$
00130$:
;	../../../core/net/tcpip.c:628: if(uip_ds6_is_my_addr(&UIP_IP_BUF->srcipaddr)){
	...
	orl	a,r3
	jz	00127$
;	../../../core/net/tcpip.c:629: uip_nd6_ns_output(&UIP_IP_BUF->srcipaddr, NULL, &nbr->ipaddr);
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_566
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00246$:
	...
	sjmp	00128$
00127$:
;	../../../core/net/tcpip.c:631: uip_nd6_ns_output(NULL, NULL, &nbr->ipaddr);
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_566
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00247$:
	...
	mov	sp,a
00128$:
;	../../../core/net/tcpip.c:634: stimer_set(&nbr->sendns, uip_ds6_if.retrans_timer / 1000);
	...
	add	a,#0xfc
	mov	sp,a
;	../../../core/net/tcpip.c:635: nbr->nscount = 1;
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_566
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	ljmp	00140$
00137$:
;	../../../core/net/tcpip.c:638: if(nbr->state == NBR_INCOMPLETE) {
	mov	a,#0x2d
	add	a,r5
	mov	r5,a
	clr	a
	...
	mov	r4,a
	jnz	00133$
;	../../../core/net/tcpip.c:648: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:649: return;
	ljmp	00141$
00133$:
;	../../../core/net/tcpip.c:653: if(nbr->state == NBR_STALE) {
	cjne	r4,#0x02,00135$
;	../../../core/net/tcpip.c:654: nbr->state = NBR_DELAY;
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	mov	a,#0x03
	lcall	__gptrput
;	../../../core/net/tcpip.c:655: stimer_set(&nbr->reachable, UIP_ND6_DELAY_FIRST_PROBE_TIME);
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_566
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	add	a,#0xfc
	mov	sp,a
;	../../../core/net/tcpip.c:656: nbr->nscount = 0;
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_566
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	lcall	__gptrput
00135$:
;	../../../core/net/tcpip.c:660: tcpip_output(&nbr->lladdr);
	mov	dptr,#_tcpip_ipv6_output_nbr_65536_566
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	lcall	__sdcc_banked_call
;	../../../core/net/tcpip.c:677: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:678: return;
	sjmp	00141$
00140$:
;	../../../core/net/tcpip.c:683: tcpip_output(NULL);
	mov	dptr,#0x0000
	mov	b,#0x00
	mov	r0,#_tcpip_output
	mov	r1,#(_tcpip_output >> 8)
	mov	r2,#(_tcpip_output >> 16)
	lcall	__sdcc_banked_call
;	../../../core/net/tcpip.c:684: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../core/net/tcpip.c:685: uip_ext_len = 0;
	mov	dptr,#_uip_ext_len
	movx	@dptr,a
00141$:
;	../../../core/net/tcpip.c:686: }
	mov	a,sp
	add	a,#0xfc
	mov	sp,a
	ljmp	__sdcc_banked_ret
...
;conn                      Allocated to registers r5 r6 r7 
;------------------------------------------------------------
;	../../../core/net/tcpip.c:691: tcpip_poll_udp(struct uip_udp_conn *conn)
;	-----------------------------------------
...
_tcpip_poll_udp:
	...
	mov	r6,dph
	mov	r7,b
;	../../../core/net/tcpip.c:693: process_post(&tcpip_process, UDP_POLL, conn);
	push	ar5
	push	ar6
	push	ar7
	mov	a,#0x01
...
;ts                        Allocated with name '_tcpip_uipcall_ts_65536_590'
;------------------------------------------------------------
;	../../../core/net/tcpip.c:706: tcpip_uipcall(void)
;	-----------------------------------------
...
_tcpip_uipcall:
	...
	add	a,#0x06
	mov	sp,a
;	../../../core/net/tcpip.c:711: if(uip_conn != NULL) {
	mov	dptr,#_uip_conn
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	orl	a,b
	jz	00102$
;	../../../core/net/tcpip.c:712: ts = &uip_conn->appstate;
	mov	dptr,#_tcpip_uipcall_ts_65536_590
	mov	a,#0x28
	add	a,r5
	movx	@dptr,a
	clr	a
	...
	sjmp	00103$
00102$:
;	../../../core/net/tcpip.c:714: ts = &uip_udp_conn->appstate;
	mov	dptr,#_uip_udp_conn
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	movx	@dptr,a
00103$:
;	../../../core/net/tcpip.c:745: if(ts->p != NULL) {
	mov	dptr,#_tcpip_uipcall_ts_65536_590
	movx	a,@dptr
	mov	r7,a
	inc	dptr
	...
	ljmp	00106$
00117$:
;	../../../core/net/tcpip.c:748: ts->p->thread(&ts->p->pt, tcpip_event, ts->state);
	mov	r0,sp
	dec	r0
	dec	r0
	mov	a,#0x03
...
;------------------------------------------------------------
;	../../../core/net/tcpip.c:755: PROCESS_THREAD(tcpip_process, ev, data)
;	-----------------------------------------
;	 function process_thread_tcpip_process
;	-----------------------------------------
_process_thread_tcpip_process:
;	../../../core/net/tcpip.c:757: PROCESS_BEGIN();
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
	mov	r4,#0x01
...
00131$:
	ljmp	00111$
00101$:
;	../../../core/net/tcpip.c:770: tcpip_event = process_alloc_event();
	push	ar5
	push	ar6
	push	ar7
	push	ar7
	...
	mov	dptr,#_tcpip_event
	movx	@dptr,a
;	../../../core/net/tcpip.c:774: etimer_set(&periodic, CLOCK_SECOND / 2);
	mov	a,#0x40
	push	acc
	clr	a
	push	acc
...
;	../../../core/net/tcpip.c:776: uip_init();
	...
	pop	ar6
	pop	ar7
;	../../../core/net/tcpip.c:778: UIP_FALLBACK_INTERFACE.init();
	mov	dptr,#_slip_interface
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	movx	a,@dptr
...
;	../../../core/net/tcpip.c:782: rpl_init();
	...
	pop	ar6
	pop	ar7
;	../../../core/net/tcpip.c:790: PROCESS_END();
	pop	ar7
	pop	ar6
	pop	ar5
;	../../../core/net/tcpip.c:785: while(1) {
00109$:
;	../../../core/net/tcpip.c:786: PROCESS_YIELD();
	mov	r4,#0x00
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
...
00102$:
	...
	sjmp	00112$
00106$:
;	../../../core/net/tcpip.c:787: eventhandler(ev, data);
	push	ar7
	push	ar6
	push	ar5
	mov	a,sp
