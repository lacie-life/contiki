...
;------------------------------------------------------------
;symbol                    Allocated to stack - sp -65
;symtab                    Allocated to stack - sp -67
;symtabsize                Allocated to stack - sp -69
;strtab                    Allocated to stack - sp -71
;fd                        Allocated to stack - sp -59
;s                         Allocated to stack - sp -45
;a                         Allocated to registers 
;name                      Allocated to stack - sp -29
;sect                      Allocated to registers r2 r6 r7 
;sloc0                     Allocated to stack - sp -57
;sloc1                     Allocated to stack - sp -55
;sloc2                     Allocated to stack - sp -53
;sloc3                     Allocated to stack - sp -49
;sloc4                     Allocated to stack - sp -48
;------------------------------------------------------------
...
;------------------------------------------------------------
;section                   Allocated to stack - sp -82
;size                      Allocated to stack - sp -84
;sectionaddr               Allocated to stack - sp -86
;sectionbase               Allocated to stack - sp -89
;strs                      Allocated to stack - sp -91
;strtab                    Allocated to stack - sp -93
;symtab                    Allocated to stack - sp -95
;symtabsize                Allocated to stack - sp -97
;using_relas               Allocated to stack - sp -98
;fd                        Allocated to stack - sp -77
...
;sloc0                     Allocated to stack - sp -75
...
;------------------------------------------------------------
;fd                        Allocated to stack - sp -230
;ehdr                      Allocated to stack - sp -114
;shdr                      Allocated to stack - sp -61
;strtable                  Allocated to stack - sp -154
;strs                      Allocated to stack - sp -19
;shdrptr                   Allocated to stack - sp -168
;nameptr                   Allocated to registers 
;name                      Allocated to stack - sp -166
;i                         Allocated to stack - sp -21
;shdrnum                   Allocated to stack - sp -17
;shdrsize                  Allocated to stack - sp -15
;using_relas               Allocated to stack - sp -62
;textoff                   Allocated to stack - sp -13
;textsize                  Allocated to stack - sp -11
;textrelaoff               Allocated to stack - sp -172
;textrelasize              Allocated to stack - sp -212
;dataoff                   Allocated to stack - sp -9
;datasize                  Allocated to stack - sp -214
;datarelaoff               Allocated to stack - sp -228
;datarelasize              Allocated to stack - sp -216
;rodataoff                 Allocated to stack - sp -7
;rodatasize                Allocated to stack - sp -218
;rodatarelaoff             Allocated to stack - sp -226
;rodatarelasize            Allocated to stack - sp -220
;symtaboff                 Allocated to stack - sp -5
;symtabsize                Allocated to stack - sp -3
;strtaboff                 Allocated to stack - sp -1
;strtabsize                Allocated to stack - sp -222
;bsssize                   Allocated to stack - sp -224
;process                   Allocated to stack - sp -176
;ret                       Allocated to registers r6 r7 
;sloc0                     Allocated to stack - sp -228
;sloc1                     Allocated to stack - sp -226
;sloc2                     Allocated to stack - sp -224
;sloc3                     Allocated to stack - sp -26
;sloc4                     Allocated to stack - sp -222
;sloc5                     Allocated to stack - sp -220
;sloc6                     Allocated to stack - sp -218
;sloc7                     Allocated to stack - sp -216
;sloc8                     Allocated to stack - sp -214
;sloc9                     Allocated to stack - sp -212
;sloc10                    Allocated to stack - sp -210
;sloc11                    Allocated to stack - sp -12
;sloc12                    Allocated to stack - sp -209
;sloc13                    Allocated to stack - sp -208
;sloc14                    Allocated to stack - sp -207
;sloc15                    Allocated to stack - sp -206
;sloc16                    Allocated to stack - sp -205
;sloc17                    Allocated to stack - sp -204
;sloc18                    Allocated to stack - sp -203
;sloc19                    Allocated to stack - sp -202
;sloc20                    Allocated to stack - sp -201
;sloc21                    Allocated to stack - sp -200
;sloc22                    Allocated to stack - sp -199
;sloc23                    Allocated to stack - sp -198
;sloc24                    Allocated to stack - sp -197
;sloc25                    Allocated to stack - sp -196
;sloc26                    Allocated to stack - sp -195
;sloc27                    Allocated to stack - sp -194
;sloc28                    Allocated to stack - sp -193
;sloc29                    Allocated to stack - sp -192
;sloc30                    Allocated to stack - sp -191
;sloc31                    Allocated to stack - sp -190
;sloc32                    Allocated to stack - sp -189
;sloc33                    Allocated to stack - sp -188
;sloc34                    Allocated to stack - sp -187
;sloc35                    Allocated to stack - sp -186
;sloc36                    Allocated to stack - sp -185
;sloc37                    Allocated to stack - sp -184
;sloc38                    Allocated to stack - sp -183
;sloc39                    Allocated to stack - sp -182
;sloc40                    Allocated to stack - sp -181
;sloc41                    Allocated to stack - sp -180
;sloc42                    Allocated to stack - sp -179
;sloc43                    Allocated to stack - sp -178
;sloc44                    Allocated to stack - sp -177
;sloc45                    Allocated to stack - sp -176
;sloc46                    Allocated to stack - sp -172
;sloc47                    Allocated to stack - sp -170
;------------------------------------------------------------
...
;	../../../core/loader/elfloader.c:521: if(textrelasize > 0) {
	...
	ljmp	00175$
00355$:
;	../../../core/loader/elfloader.c:528: symtaboff, symtabsize, using_relas);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/loader/elfloader.c:527: strtaboff,
	mov	r0,sp
	dec	r0
	mov	a,sp
	add	a,#0x50
...
;	../../../core/loader/elfloader.c:525: text.address,
	...
	movx	a,@dptr
	mov	r7,a
;	../../../core/loader/elfloader.c:524: textoff,
	mov	a,sp
	add	a,#0xf3
	mov	r0,a
	mov	a,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/loader/elfloader.c:523: textrelaoff, textrelasize,
	mov	a,sp
	add	a,#0x54
	mov	r0,a
	mov	ar2,@r0
...
;	../../../core/loader/elfloader.c:536: if(rodatarelasize > 0) {
	...
	ljmp	00183$
00357$:
;	../../../core/loader/elfloader.c:543: symtaboff, symtabsize, using_relas);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/loader/elfloader.c:542: strtaboff,
	mov	r0,sp
	dec	r0
	mov	a,sp
	add	a,#0x56
...
;	../../../core/loader/elfloader.c:540: rodata.address,
	...
	movx	a,@dptr
	mov	r7,a
;	../../../core/loader/elfloader.c:539: rodataoff,
	mov	a,sp
	add	a,#0xf9
	mov	r0,a
	mov	a,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/loader/elfloader.c:538: rodatarelaoff, rodatarelasize,
	mov	a,sp
	add	a,#0x1e
	mov	r0,a
	mov	ar3,@r0
...
;	../../../core/loader/elfloader.c:552: if(datarelasize > 0) {
	...
	ljmp	00190$
00359$:
;	../../../core/loader/elfloader.c:559: symtaboff, symtabsize, using_relas);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/loader/elfloader.c:558: strtaboff,
	mov	r0,sp
	dec	r0
	mov	a,sp
	add	a,#0x56
...
;	../../../core/loader/elfloader.c:556: data.address,
	...
	movx	a,@dptr
	mov	r7,a
;	../../../core/loader/elfloader.c:555: dataoff,
	mov	a,sp
	add	a,#0xf7
	mov	r0,a
	mov	a,sp
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/loader/elfloader.c:554: datarelaoff, datarelasize,
	mov	a,sp
	add	a,#0x1c
	mov	r0,a
	mov	ar3,@r0
