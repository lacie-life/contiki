...
;	../../../core/net/neighbor-attr.c:82: return list_head(neighbor_addrs);
	...
	mov	r6,dph
	mov	r7,b
;	../../../core/net/neighbor-attr.c:83: }
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_attr'
;------------------------------------------------------------
;index                     Allocated to stack - sp -14
;attr                      Allocated to stack - sp -9
...
;attr                      Allocated to registers r2 r3 r4 
...
;------------------------------------------------------------
;addr                      Allocated to stack - sp -16
;data                      Allocated to stack - sp -19
;def                       Allocated to stack - sp -10
