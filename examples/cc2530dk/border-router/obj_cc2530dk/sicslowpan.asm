...
;------------------------------------------------------------
;ipaddr                    Allocated to stack - sp -14
;lladdr                    Allocated to stack - sp -17
...
;------------------------------------------------------------
;rime_destaddr             Allocated to stack - sp -15
...
;------------------------------------------------------------
;ip_len                    Allocated to stack - sp -13
;tmp                       Allocated to stack - sp -3
;iphc0                     Allocated to stack - sp -2
;iphc1                     Allocated to registers r7 
...
;dest                      Allocated with name '_output_dest_65536_561'
;------------------------------------------------------------
...
;	../../../core/net/sicslowpan.c:1413: rimeaddr_copy(&dest, &rimeaddr_null);
	...
	mov	a,#0x80
	push	acc
	mov	dptr,#_output_dest_65536_561
	mov	b,#0x00
