...
_num_sensors:
	.ds 1
_process_thread_sensors_process_i_65536_113:
	.ds 2
_process_thread_sensors_process_events_65536_113:
	.ds 2
;--------------------------------------------------------
...
;i                         Allocated with name '_process_thread_sensors_process_i_65536_113'
;events                    Allocated with name '_process_thread_sensors_process_events_65536_113'
;------------------------------------------------------------
...
;	../../../core/lib/sensors.c:111: for(i = 0; sensors[i] != NULL; ++i) {
	mov	dptr,#_process_thread_sensors_process_i_65536_113
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;	../../../core/lib/sensors.c:122: events = 0;
	mov	dptr,#_process_thread_sensors_process_events_65536_113
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
