...
;encounter_time            Allocated to stack - sp -70
;strobes                   Allocated to registers 
;hdr                       Allocated to registers r2 r3 r7 
;got_strobe_ack            Allocated to stack - sp -68
;strobe                    Allocated to stack - sp -66
;strobe_len                Allocated to stack - sp -16
;len                       Allocated to registers r5 r3 
...
;sloc1                     Allocated to stack - sp -78
;sloc2                     Allocated to stack - sp -75
;------------------------------------------------------------
