...
;------------------------------------------------------------
;mac_callback_ptr          Allocated to stack - sp -34
;buf_list                  Allocated to stack - sp -37
;mac_callback              Allocated to stack - sp -28
;t0                        Allocated to stack - sp -15
;encounter_time            Allocated to stack - sp -13
;strobes                   Allocated to registers 
;got_strobe_ack            Allocated to stack - sp -9
...
;collisions                Allocated to stack - sp -11
;transmit_len              Allocated to registers r7 r3 
;ret                       Allocated to registers r6 r7 
;contikimac_was_on         Allocated to stack - sp -10
